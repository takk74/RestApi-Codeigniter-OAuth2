# APIREST Codeigniter 4 + OAuth2

## CREATION DU PROJET

### Créer un projet code igniter via composer
...
### 3/ Aller dans app/Config/Boot/development.php et app/Config/Boot/.php et changez le display_errors valeur à 1 plutôt que 0.
...
http://localhost:8080/restcontroller/1
...
### Créer une fichier CiOAuth.php dans le dossier libraries
```
<?php
...
#### Une fis la requete POST envoyé , un acces token est renvoyé pour nous permettre d'acceder à toutes nos routes.
